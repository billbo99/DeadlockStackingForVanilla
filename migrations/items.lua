...
Items.items = {
    ...
    -- tier 1
    ["wood"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["copper-ore"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["copper-plate"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["iron-ore"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["iron-plate"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["coal"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["stone"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    ["stone-brick"] = { tier = "deadlock-stacking-1", sub_group = "logistics" },
    ["steel-plate"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" },
    -- tier 2
    ["copper-cable"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["iron-gear-wheel"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["iron-stick"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["sulfur"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["plastic-bar"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["solid-fuel"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["electronic-circuit"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    ["advanced-circuit"] = { tier = "deadlock-stacking-2", sub_group = "intermediates" },
    -- tier 3
    ["battery"] = { tier = "deadlock-stacking-3", sub_group = "intermediates" },
    ["processing-unit"] = { tier = "deadlock-stacking-3", sub_group = "intermediates" },
    ["uranium-235"] = { tier = "deadlock-stacking-3", sub_group = "intermediates" },
    ["uranium-238"] = { tier = "deadlock-stacking-3", sub_group = "intermediates" },
    ["uranium-ore"] = { tier = "deadlock-stacking-3", sub_group = "intermediates" },
    --
    -- inserters
...
if settings.startup['stack_intermediates_early'].value then
    Items.items["copper-cable"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" }
    Items.items["iron-gear-wheel"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" }
    Items.items["iron-stick"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" }
    Items.items["electronic-circuit"] = { tier = "deadlock-stacking-1", sub_group = "intermediates" }
end
